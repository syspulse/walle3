...
object Dependencies {
    ...
    val libSkelBlockchain = "io.syspulse"                 %% "skel-blockchain"          % skelVersion    
    
    val libSkel = Seq(libSkelCore,libSkelAuth, libSkelCrypto, libSkelCryptoKSM, libSkelCron, libSkelBlockchain, libScalaTest)
