...
object Dependencies {
    ...
    val libSkel = Seq(libSkelCore,libSkelAuth, libSkelCrypto, libSkelCryptoKSM, libSkelCron, libSkelBlockchainCore, libSkelBlockchainRpc, libScalaTest)
